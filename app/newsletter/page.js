...
//       <p className="mb-6">Get updates delivered straight to your inbox.</p>
//       <NewsletterForm />
//     </div>
//   );
// }
  ...
  return (
    <div className="newsletter-container bg-accent text-white tracking-wider font-chunk p-8">
      <div className="newsletter-content text-center">
        <h2 className="tracking-wider text-4xl mb-4">Subscribe To Our Newsletter</h2>
        <p className="mb-6">
          Stay updated with the latest news, exclusive offers, and insights.
          Subscribe now to join our growing community!
        </p>
        <form className="newsletter-form flex flex-col items-center gap-4" onSubmit={handleSubmit}>
          <input
            type="text"
            name="name"
          ...
          <input
            ...
            className="input-field p-2 w-full max-w-md rounded-md border border-gray-300 text-black"
          />
          <button type="submit" className="submit-button bg-white text-black font-bold py-2 px-6 rounded-md hover:bg-gray-300">
            Submit
          </button>
        </form>
